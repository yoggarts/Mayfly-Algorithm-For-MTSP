...
class Particle:
    ...
    def update_costs_and_pbest(self):
        ...
        if self.current_cost < self.pbest_cost:
            ...
            self.pbest_x = self.route
            self.pbest_y = self.route
...
class PSO:
    ...
    def __init__(self, iterations, population_size, gbest_probability=1.0, pbest_probability=1.0, gbest_x_probability=1.0, pbest_x_probability=1.0,gbest_y_probability=1.0, pbest_y_probability=1.0, cities=None):
        self.cities = cities
        self.gbest = None
        self.gbest_x = None
        self.gbest_y = None
        ...
        self.gbest_x_probability = gbest_x_probability
        self.pbest_x_probability = pbest_x_probability
        self.gbest_y_probability = gbest_y_probability
        self.pbest_y_probability = pbest_y_probability
...
if __name__ == "__main__":
    ...
    pso = PSO(iterations=400, population_size=300, pbest_probability=0.9, gbest_probability=0.02,pbest_x_probability=0.9, gbest_x_probability=0.02,pbest_y_probability=0.9, gbest_y_probability=0.02, cities=cities)
    pso.run()
